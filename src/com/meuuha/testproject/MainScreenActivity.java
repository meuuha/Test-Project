...
import com.meuuha.testproject.feature1.Feature1Activity;
import com.meuuha.testproject.feature3.Feature3Activity;
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.button2:
				...
				break;
			case R.id.button3:
				startActivity(new Intent(this, Feature3Activity.class));
				break;
			case R.id.button4:
